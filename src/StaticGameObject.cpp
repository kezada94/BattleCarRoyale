...
StaticGameObject::StaticGameObject(const char* path, GLuint shaderprog, btVector3 startPos, btQuaternion startRot, btCollisionShape* coll)
    : GameObject(path, shaderprog, btScalar(0), startPos, startRot, coll) {}

StaticGameObject::StaticGameObject(const char* path, GLuint shaderprog, btVector3 startPos, btQuaternion startRot)
    : GameObject(path, shaderprog, btScalar(0), startPos, startRot) {}
